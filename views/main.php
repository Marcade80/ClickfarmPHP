...
<html lang="en">
  <head>
    ...
    <script src="<?php echo HOME_URL; ?>/public/inc/base.js"></script>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDonateDropdown">
                        <a class="dropdown-item" target="_blank" href="https://www.buymeacoffee.com/bonusbrief"><i class="fab fa-fw fa-paypal"></i> Buy me a coffee</a>
                    </div>
                </li>
    ...
    <div class="container-fluid" id="FirstTab">
        ...
        <div class="row border border-dark rows" id="productie-row">
            <div class="container col-sm" id="chicken-col">
                ...
                <h3>Kippen:</h3>
                <div id="Chickens"></div>
                <button type="button" class="btn btn-primary" id="CickenAnd1" onclick="objChicken.add(1);">+1</button>
                <button type="button" class="btn btn-primary" id="CickenAnd10" onclick="objChicken.add(10);">+10</button>
                <button type="button" class="btn btn-primary" id="CickenAnd100" onclick="objChicken.add(100);">+100</button>
                <button type="button" class="btn btn-primary" id="CickenAnd1000" onclick="objChicken.add(1000);">+1.000</button>
                <button type="button" class="btn btn-primary" id="CickenAnd10000" onclick="objChicken.add(10000);">+10.000</button>
                <button type="button" class="btn btn-primary" id="CickenAnd100000" onclick="objChicken.add(100000);">+100.000</button>
                <h3>Verkopen:</h3>
                <div id="eggs"></div>
                <div id="eggStock"></div>
        ...
        <div class="row border border-dark rows" id="plastic-row">
            ...
            <div class="container col-sm" id="plasticStorage-col">
                ...
                <button type="button" class="btn btn-danger" onClick="objPlastic.sell(0, 'Handmatige verkoop kunststof');" id="sellPlastic">Verkoop kunststof</button>
    ...
    <script src="<?php echo HOME_URL; ?>/public/inc/jquery-3.3.1.slim.min.js"></script>
    <script src="<?php echo HOME_URL; ?>/public/inc/bootstrap.bundle.min.js"></script>
    <script defer src="<?php echo HOME_URL; ?>/public/inc/fontawesome_all.js"></script>
  </body>
</html>
